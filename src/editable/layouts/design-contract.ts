...
export const editableRootStyle = {
  ...
  '--slot4-panel-bg': '#f7f7f8',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#6c6c89',
  '--slot4-soft-muted-text': '#a9a9bc',
  '--slot4-accent': '#f14a1c',
  '--slot4-accent-fill': '#f14a1c',
  '--slot4-accent-soft': '#fde4dd',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#000000',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#f7f7f8',
  '--slot4-cream': '#fafafa',
  '--slot4-warm': '#f7f7f8',
  ...
  '--editable-border': '#eeeeee',
  '--editable-nav-bg': '#ffffff',
  '--editable-nav-text': '#000000',
  '--editable-nav-active': '#f14a1c',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#f14a1c',
...
export const editableDesignContract = {
  ...
  type: {
    ...
    heroTitle: 'text-4xl font-bold leading-[1.12] tracking-[-0.02em] sm:text-5xl lg:text-[3.5rem]',
  ...
  button: {
    primary: `inline-flex items-center justify-center gap-2 rounded-lg bg-[var(--slot4-accent-fill)] px-6 py-3 text-sm font-semibold text-[var(--slot4-on-accent)] transition duration-200 hover:brightness-90 active:scale-[0.98]`,
    secondary: `inline-flex items-center justify-center gap-2 rounded-lg border border-[var(--editable-border)] bg-[var(--slot4-surface-bg)] px-6 py-3 text-sm font-semibold text-[var(--slot4-page-text)] transition duration-200 hover:border-[var(--slot4-accent)] hover:text-[var(--slot4-accent)] active:scale-[0.98]`,
    accent: `inline-flex items-center justify-center gap-2 rounded-lg ${editablePalette.accentBg} px-6 py-3 text-sm font-semibold text-[var(--slot4-on-accent)] transition duration-200 hover:brightness-90 active:scale-[0.98]`,
  },
  media: {
