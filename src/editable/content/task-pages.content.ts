...
export const taskPageVoices = {
  ...
  sbm: {
    eyebrow: 'Collections',
    headline: 'Curated resources organized into browsable collections.',
    description: 'Discover tools, references, and links submitted by curators and organized into collections for easy browsing.',
    filterLabel: 'Filter collection',
    secondaryNote: 'Curated resources with grouping and verified metadata.',
    chips: ['Collections', 'Resources', 'Curated links'],
  },
  profile: {
    eyebrow: 'Curators',
    headline: 'Curators with identity, trust, and reputation.',
    description: 'Curator pages make people and their collections discoverable rather than buried in a generic feed.',
    filterLabel: 'Filter curator category',
    secondaryNote: 'Make identity and credibility visible before the grid begins.',
    chips: ['Identity first', 'Trust cues', 'Curator cards'],
  },
  pdf: {
