export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'relishhost',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Relishhost',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'relishhost.net',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://relishhost.net',
